 ...
 * {@link Seige.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link Seige#newInstance} factory method to
 * create an instance of this fragment.
 */
public class Seige extends Fragment implements OnChartValueSelectedListener {
     ...
     * @return A new instance of fragment Seige.
     */
    // TODO: Rename and change types and number of parameters
    public static Seige newInstance(String param1, String param2) {
        Seige fragment = new Seige();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        final View view = inflater.inflate(R.layout.fragment_seige, container, false);
        kills = (EditText) view.findViewById(R.id.r6_kills);
        deaths = (EditText) view.findViewById(R.id.r6_deaths);
        pi =(PieChart) view.findViewById(R.id.r6_chart);
        pi.setUsePercentValues(true);
        history = (TextView) view.findViewById(R.id.r6_history);
        updatebtn = (Button) view.findViewById(R.id.r6_update);
        checkbtn = (Button) view.findViewById(R.id.r6_check);
        ratingbar = (RatingBar) view.findViewById(R.id.ratingBar_seige) ;
        ratingbar.setMax(5);
        getdata();
                    ...
                    Thread t = new Thread(new Runnable() {
                        ...
                        public void run() {
                            getActivity().runOnUiThread(new Runnable() {
                                @Override
                                public void run() {
                                    String url = "Insertdata/1/"+kills.getText().toString()+"/"+deaths.getText().toString();
                                    String url2 ="SetRating/1/"+ Math.round(ratingbar.getRating());
                                    try {
